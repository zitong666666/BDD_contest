...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default=ROOT / 'models/hub/yolov5l6.yaml', help='model.yaml path')
    # 训练数据集路径（示例:data/voc-cs.yaml）
    # 2.(需要修改default=ROOT / 'data/coco128.yaml')
